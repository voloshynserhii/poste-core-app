...
function sortArrayByObjectValue(array, propertyToCompare = 'name') {
  return array.sort((a, b) => (a.hasOwnProperty(propertyToCompare) > b[propertyToCompare] ? 1 : b[propertyToCompare] > a[propertyToCompare] ? -1 : 0));
}
...
export {
  ...
  compareObjects,
  stableSort,
  stableSortForObjectsByProperty,
  isNumeric,
